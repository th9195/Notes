...
有了Watermark 就可以==在一定程度上==解决数据乱序或延迟达到问题! 
...
![1615089127497](images/1615089127497.png)
...
### Managed State & Raw State / 托管状态和原始状态
...
## 代码演示-Managed State-Keyed State-掌握
...
## 代码演示-Managed State-Operator State-了解
